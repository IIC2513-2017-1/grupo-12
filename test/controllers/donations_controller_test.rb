...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { amount: @donation.amount, project_id: @donation.project_id, user_id: @donation.user_id } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { amount: @donation.amount, project_id: @donation.project_id, user_id: @donation.user_id } }
